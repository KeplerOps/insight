export var DevelopmentPhase;
(function (DevelopmentPhase) {
    DevelopmentPhase["Concept"] = "concept";
    DevelopmentPhase["Requirements"] = "requirements";
    DevelopmentPhase["Design"] = "design";
    DevelopmentPhase["UnitTestDesign"] = "unit-test-design";
    DevelopmentPhase["UnitTestImplementation"] = "unit-test-implementation";
    DevelopmentPhase["IntegrationTestDesign"] = "integration-test-design";
    DevelopmentPhase["Implementation"] = "implementation";
    DevelopmentPhase["Integration"] = "integration";
})(DevelopmentPhase || (DevelopmentPhase = {}));
export const PROMPTS = {
    conceptRefinement: {
        phase: DevelopmentPhase.Concept,
        type: 'refinement',
        content: `Help the user refine their software concept before it is time to work on requirements. No code please. Do not solution. The point is to refine the concept just enough so we can write requirements later, including the scope of the project, which could be anything from a tiny script to a full-blown multi-tenant globally distributed SaaS platform. Don't jump ahead.`
    },
    conceptAssessment: {
        phase: DevelopmentPhase.Concept,
        type: 'assessment',
        content: `As a world-class technical product manager, on a scale of 0 to 10 rate whether there is enough concept information to write a first comprehensive draft of functional and non-functional requirements. The goal isn't to already have requirements from the user. It's to understand the user's goal enough that we can write a comprehensive first draft of requirements, even if that means we have to make some assumptions and use good judgement as a product manager.`
    },
    requirementsCreation: {
        phase: DevelopmentPhase.Requirements,
        type: 'creation',
        content: `As a world-class technical product manager create a comprehensive requirements document for the concept following this exact structure.
...
Run the tests to ensure they fail. All stubs will throw not implemented exceptions, which is NOT the expected behaviour for the system.`
    ...
    integrationTestDesign: {
        ...
        type: 'design',
        content: `As a world-class QA engineer, design the integration test suite to provide comprehensive coverage for the design and requirements. DO NOT IMPLEMENT. Provide the test files, test classes, fixtures, test method signatures, and full documentation. Cover all expected behaviour, exceptions and edge cases. Remember, the methods in the implementation classes are INTENTIONALLY stubbed. This is TDD. Write the test for the EXPECTED behaviour once they are implemented, not the stubbed behaviour.
...
export const QUALITY_GATES = {
    conceptToRequirements: {
        name: 'Concept to Requirements',
        phase: DevelopmentPhase.Concept,
        criteria: [
            {
                name: 'clarity',
                description: 'How clear and unambiguous is the concept?',
                threshold: 8,
                weight: 1
            },
            {
                name: 'understanding',
                description: 'How well is the user goal understood?',
                threshold: 9,
                weight: 1
            },
            {
                name: 'goalAlignment',
                description: 'How well does the concept align with user goals?',
                threshold: 9,
                weight: 1
            }
        ]
    ...
    requirementsToDesign: {
        ...
        criteria: [
            {
                name: 'completeness',
                description: 'How complete are the requirements?',
                threshold: 9,
                weight: 1
            },
            {
                name: 'consistency',
                description: 'How internally consistent are the requirements?',
                threshold: 9,
                weight: 1
            },
            {
                name: 'implementability',
                description: 'How implementable are the requirements?',
                threshold: 8,
                weight: 1
            }
        ]
    }
    // Additional gates would be defined here...
};
